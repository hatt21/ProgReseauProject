...
import fr.upem.net.tcp.Request.FusionInitRequest;

import java.nio.ByteBuffer;
import java.util.ArrayList;

public class FusionInitReader implements Reader<FusionInitRequest> {
    ...
    @Override
    public FusionInitRequest get() {
        if (state != State.DONE) {
            throw new IllegalStateException();
        }
        return new FusionInitRequest( name, version,IpAddress,port, nbMembers, namesMembers);
    }
