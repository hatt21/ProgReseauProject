...
import fr.upem.net.tcp.Request.FusionFwdRequest;

import java.nio.ByteBuffer;

public class FusionFwdReader implements Reader<FusionFwdRequest> {
    ...
    @Override
    public FusionFwdRequest get() {
        if (state != State.DONE) {
            throw new IllegalStateException();
        }
        return new FusionFwdRequest(version,IpAddress,port);
    }
